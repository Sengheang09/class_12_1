...
import com.example.springsercurityjwt121.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public SecurityConfig(CustomUserDetailService userDetails, JwtAuthenticationFilter jwtAuthenticationFilter) {
